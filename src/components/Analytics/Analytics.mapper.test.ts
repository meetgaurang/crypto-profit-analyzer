...
import {IHistoricDataAPIResponse, IHistoricRecord} from '../../api/HistoricDataAPI.types';
import {IDateWiseRecord} from "./Analytics.types";
...
describe('AnalyticsMapper', () => {
    ...
    describe('mapResponse', () => {
        it('will map daily records', () => {
                ...
                records: [
                    {
                        ...
                        date: "20180507",
                        quotes: [
                            {time: "0900", price: 1.00},
                            {time: "1000", price: 2.00}
                        ]
                    },
                    {
                        currency: "ETC",
            ...
            const records: IDateWiseRecord[] = mapper.mapResponse(response);
